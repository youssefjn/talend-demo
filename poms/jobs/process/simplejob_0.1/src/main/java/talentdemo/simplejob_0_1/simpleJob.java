...
package talentdemo.simplejob_0_1;
...
/**
 * Job: simpleJob Purpose: Display a message<br>
 * Description: This tutorial uses a component to display a message box with a
 * custom message <br>
 * 
 ...
 * @status
 */
public class simpleJob implements TalendJob {
	...
	private final String jobName = "simpleJob";
	private final String projectName = "TALENTDEMO";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(simpleJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String titletMsgBox_1 = "SimpleJob";
				String messagetMsgBox_1 = "Hello world from TOS!";
	...
	public static void main(String[] args) {
		final simpleJob simpleJobClass = new simpleJob();

		int exitCode = simpleJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = simpleJob.class.getClassLoader()
					.getResourceAsStream("talentdemo/simplejob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = simpleJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : simpleJob");
		}
...
/************************************************************************************************
 * 26679 characters generated by Talend Open Studio for Data Integration on the
 * May 23, 2023, 3:28:59 PM GMT+01:00
 ************************************************************************************************/